    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-primary text-white rounded-full p-3.5 sm:p-4 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:scale-110 active:scale-95 transition-all duration-300 animate-in fade-in zoom-in"
